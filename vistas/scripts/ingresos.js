...
{
	$.post("../ajax/ingresos.php?op=mostrar",{id_ingreso : id_ingreso}, function(data, status)
	{
...
function desactivar(id_ingreso)
{
	bootbox.confirm("¿Está seguro de desactivar el ingreso?", function(result){
		if(result)
        {
        	$.post("../ajax/ingresos.php?op=desactivar", {id_ingreso : id_ingreso}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
...
function activar(id_ingreso)
{
	bootbox.confirm("¿Está seguro de activar el ingreso?", function(result){
		if(result)
        {
        	$.post("../ajax/ingresos.php?op=activar", {id_ingreso : id_ingreso}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
