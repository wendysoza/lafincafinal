                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <label>Número de oficio(*):</label> 
                            <input type="hidden" name="id_d_r1" id="id_d_r1">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>De(*):</label>
                            <input type="text" class="form-control" name="de" id="de" placeholder="De" required>
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="file" class="form-control" name="documento_r1" id="documento_r1" style="width: 26%" accept="application/pdf,application/vnd.ms-excel">
...
<script type="text/javascript" src="scripts/docrentidad.js"></script>
<?php 
}
ob_end_flush();
?>